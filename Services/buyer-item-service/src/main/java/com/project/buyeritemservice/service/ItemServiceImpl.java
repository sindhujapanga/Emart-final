...
public class ItemServiceImpl implements ItemService {
	...
	public ItemPojo addItem(ItemPojo itemPojo) {
		...
		ItemEntity itemEntity = new ItemEntity(itemPojo.getId(), itemPojo.getName(), sellerSignupEntity, subCategoryEntity,
				itemPojo.getPrice(),itemPojo.getDescription(),itemPojo.getStock(),itemPojo.getRemarks(),itemPojo.getImage());
